...
(1, 0, 1, 'Программариус', 'adco.obshya.com,adco2.obshya.com,programmarius.admintrix.com', 'ru', 'no-reply@programmarius.ru', 1, 0, '', 'http://programmarius.ru/', '', 'tools.png', '<br />Компания по созданию сайтов любой сложности.', 30, 10);
