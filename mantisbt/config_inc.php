...
$g_administrator_email  = 'webmaster@dipstart.ru';
$g_webmaster_email      = 'webmaster@dipstart.ru';
$g_from_email           = 'noreply@example.com';	# the "From: " field in emails
$g_return_path_email    = 'webmaster@dipstart.ru';	# the return address for bounced mail
