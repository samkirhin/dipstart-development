	...
	<div class="form message-create">	
		...
		<div class="mailbox-input-row">
			<div style="float:left">
				<?php echo CHtml::activeLabelEx($conv, Yii::t('MailboxModule.mailbox', 'to')); ?>
			</div>
		...
		<div class="mailbox-input-row">
			<div style="float:left">
				<?php echo CHtml::activeLabelEx($conv,Yii::t('MailboxModule.mailbox', 'subject'),array('class'=>'mailbox-label')); ?>
			</div>
		...
		<?php echo $form->textArea($msg,'text',array('cols'=>50,'rows'=>7, 'class'=>'mailbox-message-input','style'=>'width:100%;','placeholder'=>Yii::t('MailboxModule.mailbox', 'Enter message here...'))); ?>
		<?php echo $form->error($msg,'text'); ?>
		</div>
		<div class="button-new-message">
		<button class="btn btn-large message-btn-reply btn-primary"><?=Yii::t('MailboxModule.mailbox', 'Send Message')?></button>
		</div>
	</div>
