       ...
       <tr>
        ...
        <tr>
            ...
            <td>
				...
				<button class="btn btn-primary instant-send-buttons sendToRecive"<?= $diabled ?>><?=ProjectModule::t('Go')?></button>
            </td>
        </tr>
        <tr>
            <td>
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
				...
				<button class="btn btn-primary instant-send-buttons sendToPay"<?= $diabled ?>><?=ProjectModule::t('Go')?></button>
            </td>
        </tr>
        <tr>
            <td>
