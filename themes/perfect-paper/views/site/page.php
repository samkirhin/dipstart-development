<?php
?>
<form class="form-horizontal" id="yw0" action="/site/page?view=order" method="post">	<div class="panel panel-default panel-container-default" xmlns="http://www.w3.org/1999/html">
        	...
        	<div class="panel-body form-container tab-pane" id="tab-2">
            	...
            	<div class="form-group">
                	<div class="col-sm-offset-3 col-sm-9">
                    	<div class="checkbox">
                        <label>
                            <input type="checkbox" name="customer-service"> I want to order VIP customer service
                            <a class="glyphicon glyphicon-info-sign" data-toggle="tooltip" title="Lorem ipsum dolor sit amet"></a>
                        </label>
                    </div>
                </div>
                ...
                <label for="pages_number" class="col-sm-3 control-label">Number of pages:
                	...
                	<div class="col-sm-3">
                        ...
                        <input id="pages_number" name="pages_number" type="text" class="form-control pull-left" value="1">
                        <button class="btn btn-primary pull-left calc_elem" type="button">-</button>
                    </div>
                </div>
                <label for="slides_number" class="col-sm-3 control-label">Number of slides:
                	...
                	<div class="col-sm-3">
                    	<div class="input-group spinner">
                        <button class="btn btn-primary pull-left" type="button">+</button>
                        <input id="slides_number" name="slides_number" type="text" class="form-control pull-left" value="1">
                        <button class="btn btn-primary pull-left" type="button">-</button>
                    </div>
                </div>
            </div>
    ...
    <!-- Блок Footer -->
    	<div id="footer" class="row" style="margin-top:4em;">
            ...
            <a href="#"><img src="/themes/perfect-paper/img/g-plus.png"></a>
            <a href="#"><img src="/themes/perfect-paper/img/facebook.png"></a>
            <a href="#"><img src="/themes/perfect-paper/img/fbico.png"></a>
            <a href="#"><img src="/themes/perfect-paper/img/linkedin.png"></a>
        </div>
    </div>
...
jQuery('#login-form').yiiactiveform({'validateOnSubmit':true,'validateOnChange':false,'errorCssClass':'has-error','successCssClass':'has-success','inputContainer':'div.form-group','attributes':[{'id':'UserLogin_username','inputID':'UserLogin_username','errorID':'UserLogin_username_em_','model':'UserLogin','name':'username','enableAjaxValidation':true,'clientValidation':function(value, messages, attribute) {

if(jQuery.trim(value)=='') {
	messages.push("username or email cannot be blank.");
}

}},{'id':'UserLogin_password','inputID':'UserLogin_password','errorID':'UserLogin_password_em_','model':'UserLogin','name':'password','enableAjaxValidation':true,'clientValidation':function(value, messages, attribute) {

if(jQuery.trim(value)=='') {
	messages.push("password cannot be blank.");
}

}},{'id':'UserLogin_rememberMe','inputID':'UserLogin_rememberMe','errorID':'UserLogin_rememberMe_em_','model':'UserLogin','name':'rememberMe','enableAjaxValidation':true,'clientValidation':function(value, messages, attribute) {
