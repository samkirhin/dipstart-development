...
//	'viewPath'=>'E:\xampp\htdocs\dipstart\protected\views\templates',
	'name'=>'New Dipstart',
    'defaultController' => 'project/default',
    'language' => 'ru',
	// preloading 'log' component
	'preload'=>array('log','booster'),
    'theme' => explode('.',$_SERVER['SERVER_NAME']).'/adco',
    'aliases'=>array(
	...
	'components'=>array(
        ...
        //dev server
        'db'=>array(
			'connectionString' => 'mysql:host=mysql90.1gb.ru;dbname=gb_x_nolihan',
			'emulatePrepare' => true,
			'username' => 'gb_x_nolihan',
			'password' => 'fa36e97dzui',
			'charset' => 'utf8',
		),
		'errorHandler'=>array(
