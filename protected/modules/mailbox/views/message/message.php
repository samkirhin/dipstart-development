...
$this->breadcrumbs=array(
	ucfirst(Yii::t('MailboxModule.mailbox', 'Mailbox'))=>array('mailbox/inbox'),
	Yii::t('MailboxModule.mailbox', 'Message'),
);
...
$form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->error($reply,'text'); ?>
		<div class="mailbox-textarea-wrap ui-helper-clearfix">
			<textarea name="text" cols="50" rows="7" placeholder="<?=Yii::t('MailboxModule.mailbox', 'Reply here...')?>"></textarea>
		</div>
	<input type="submit" class="btn btn-large mailbox-input" value="<?=Yii::t('MailboxModule.mailbox', 'Send Reply')?>" />
	</div>
