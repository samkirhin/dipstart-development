...
switch($itemCssClass)
{
	case 'msg-read': $status = ($this->getAction()->getId()=='sent')? 'Yii::t("MailboxModule.mailbox", "Recipient has read your message")' : 'Yii::t("MailboxModule.mailbox", "Message has been read")' ; break;
	case 'msg-deliver':  $status = 'Yii::t("MailboxModule.mailbox", "Recipient has not read your message yet")';
	case 'msg-new': $status =  ($this->getAction()->getId()=='sent')? 'Yii::t("MailboxModule.mailbox", "Recipient has not read your message yet")' : 'Yii::t("MailboxModule.mailbox", "You received a new message")'; break;
	case 'msg-sent': $status = 'Yii::t("MailboxModule.mailbox", "You sent message {$username} a message")';
}
