...
class PartStatusController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['PartStatus'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PartStatus');
	...
	{
		$model=new PartStatus('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PartStatus']))
			$model->attributes=$_GET['PartStatus'];
	 ...
	 * @param PartStatus $model the model to be validated
	 */
