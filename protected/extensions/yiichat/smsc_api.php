...
define("SMSC_LOGIN", "sms-yslugi");            // логин клиента
define("SMSC_PASSWORD", "4bgfb76ghy87");    // пароль или MD5-хеш пароля в нижнем регистре
...
//echo '<br>$phones(0)='; var_dump($phones);
//	$phones .= ',+380964331189';
